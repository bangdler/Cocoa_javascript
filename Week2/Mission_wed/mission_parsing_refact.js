...
function run(data) {
    ...
    for (let i = 0; i < array.length; i++) {
        ...
        // pop 값이 [ 가 아니면 ] 갯수가 많다는 뜻으로 괄호가 일치하지 않음.
            ...
            else if (bracketStack.stack.pop() !== '[') {
        ...
        // [,] 과 같은 경우 거르기 위함. , 가 왔을 경우에 element가 비어있지 않다면 초기화 및 count +1
        else {
            if (element.length !== 0) {
                element = '';
                elementcount += 1
        ...
        depthcountArray.push([depth, elementcount])
    }
